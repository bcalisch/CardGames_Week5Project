...
public class Hand {
    ...
    public boolean equals(Object o) {
        ...
        if (getHandRank() != hand.getHandRank()) return false;
        if (getHighCard1() != hand.getHighCard1()) return false;
        if (getHighCard2() != hand.getHighCard2()) return false;
        if (getHighCard3() != hand.getHighCard3()) return false;
        if (getHighCard4() != hand.getHighCard4()) return false;
        return getHighCard5() == hand.getHighCard5();
